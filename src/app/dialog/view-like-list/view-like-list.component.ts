...
@Component({
  selector: 'app-view-like-list',
  templateUrl: './view-like-list.component.html',
  styleUrls: ['./view-like-list.component.scss']
})
export class ViewLikeListComponent {
  ...
  loadData() {
    ...
    this._appService.getApiWithAuth(`/admin/social/like-list?post_id=${this.data?.postData?.post_id}&post_type=${this.data?.postData?.type}&page=${this.currentPage + 1}&page_size=${this.pageSize}`).subscribe((res: any) => {
