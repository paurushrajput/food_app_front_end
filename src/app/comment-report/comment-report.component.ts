...
export class CommentReportComponent {
  ...
  displayedColumns: string[] = ['sr', 'desc', 'reportedTo', 'reported', 'comment', 'reported_date', 'status', 'action'];
  ...
  loadData() {
    ...
    this._appService.getApiWithAuth(`/admin/report/list?type=2&page=${this.currentPage + 1}&page_size=${this.pageSize}&is_paginated=true${query}`).subscribe((res: any) => {
